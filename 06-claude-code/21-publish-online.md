...
> 💡 **Не знаешь где лежит твой `index.html`?**
> Спроси у Claude Code прямо в VS Code:
> ```
> Где в проекте лежит index.html — в корне или в папке docs?
> ```
> Claude посмотрит структуру проекта и ответит. Этот ответ и подставляй в поле Folder.

![Claude Code отвечает где лежит index.html](../img/cc/21-claude-answers-where-index.png)
